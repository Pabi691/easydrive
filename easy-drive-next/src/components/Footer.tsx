...
export default function Footer() {
    return (
        <footer className="bg-white border-t border-slate-100 pt-20 pb-8 relative overflow-hidden">
            {/* Decorative blurs */}
            <div className="absolute -bottom-32 right-0 h-72 w-72 rounded-full bg-accent/5 blur-[80px]" />
            ...
            <div className="container mx-auto px-6 md:px-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
                    ...
                    {/* Courses */}
                    <div>
                        <h4 className="font-bold text-slate-900 mb-5 text-sm tracking-wider uppercase">Courses</h4>
                    ...
                    {/* Support */}
                    <div>
                        <h4 className="font-bold text-slate-900 mb-5 text-sm tracking-wider uppercase">Company</h4>
                        <ul className="space-y-3">
                            {["About Us", "Testimonials", "FAQs", "Terms & Conditions", "Privacy Policy"].map(item => (
                                <li key={item}>
                                    <Link href="#" className="text-sm text-slate-600 hover:text-accent transition-colors flex items-center gap-1.5 group">
                                        <ArrowRight size={12} className="text-slate-400 group-hover:text-accent group-hover:translate-x-0.5 transition-all" />
                                        {item}
                                    </Link>
                                </li>
                    ...
                    {/* Contact */}
                    <div>
                        <h4 className="font-bold text-slate-900 mb-5 text-sm tracking-wider uppercase">Contact</h4>
