...
export const courses: Course[] = [
    ...
    },
    {
        slug: "test-ready",
        title: "Test Ready",
        summary: "Got your test booked but your instructor's unavailable? We'll polish your skills and get you confident to pass — fast.",
        description:
            "You've already put in the lessons, you feel around 6 out of 10 ready, and your test is coming up — but your previous instructor is busy. Don't let your hard work go to waste. Our Test Ready sessions are focused 2-3 hour lessons built around you: we identify exactly where you need work, run you through real local test routes, and make sure you walk into that test room feeling sharp, calm, and ready.",
        badges: ["Test Prep", "2-3 Hour Sessions", "Quick Turnaround"],
        highlights: [
            "Full mock test on real local DVSA test routes with examiner-style marking",
            "Targeted work on your specific weak spots — junctions, roundabouts, manoeuvres",
            "Confidence-building so nerves don't cost you on the day",
            "Pre-test debrief so you know exactly what to expect from the examiner",
        ],
        includes: [
            "DVSA-approved instructor with local test route knowledge",
            "Focused 2-3 hour session tailored to your current level",
            "Full mock test with detailed fault breakdown and advice",
            "Test-day tips and examiner insight",
        ],
        idealFor: [
            "Learners with a test booked whose previous instructor is unavailable",
            "Drivers feeling around 6/10 ready who need that final push",
            "Anyone wanting sharp, focused prep before their practical test",
        ],
        duration: "2-3 hour focused sessions (single or back-to-back)",
        image: "/images/testdrive.jpg",
        gradient: "from-teal-500 to-cyan-600",
        metaTitle: "Test Ready Lessons | Easy-Drive.UK",
        metaDescription: "Test booked but instructor unavailable? Our Test Ready sessions sharpen your driving and boost confidence so you pass first time.",
    }
];
